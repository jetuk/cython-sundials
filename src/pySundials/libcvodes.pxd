...
#    * ----------------------------------------
    ...
    enum: CV_NO_QUAD              
    enum: CV_QRHSFUNC_FAIL        
    enum: CV_FIRST_QRHSFUNC_ERR   
    enum: CV_REPTD_QRHSFUNC_ERR   
    enum: CV_UNREC_QRHSFUNC_ERR   
    
    enum: CV_NO_SENS              
    enum: CV_SRHSFUNC_FAIL        
    enum: CV_FIRST_SRHSFUNC_ERR   
    enum: CV_REPTD_SRHSFUNC_ERR   
    enum: CV_UNREC_SRHSFUNC_ERR   
    
    enum: CV_BAD_IS               
    
    enum: CV_NO_QUADSENS          
    enum: CV_QSRHSFUNC_FAIL       
    enum: CV_FIRST_QSRHSFUNC_ERR  
    enum: CV_REPTD_QSRHSFUNC_ERR  
    enum: CV_UNREC_QSRHSFUNC_ERR  
...
#    * -----------------------------------------------------------------
    ...
    ctypedef int (*CVSensRhsFn)(int Ns, realtype t,
...
#    * -----------------------------------------------------------------
    ...
    ctypedef int (*CVSensRhs1Fn)(int Ns, realtype t,
    			    N_Vector y, N_Vector ydot,
...
#    * -----------------------------------------------------------------
    ...
    ctypedef int (*CVQuadSensRhsFn)(int Ns, realtype t,
...
#    * -----------------------------------------------------------------
    ...
    ctypedef int (*CVRhsFnB)(realtype t, N_Vector y,
    ...
    ctypedef int (*CVQuadRhsFnB)(realtype t, N_Vector y,
...
#    * -----------------------------------------------------------------
    ...
    int CVodeGetSens1(void *cvode_mem, realtype *tret, int _is, N_Vector ySout)
    
    int CVodeGetSensDky(void *cvode_mem, realtype t, int k, N_Vector *dkyA)
    int CVodeGetSensDky1(void *cvode_mem, realtype t, int k, int _is, N_Vector dky)
...
#    * -----------------------------------------------------------------
    ...
    int CVodeGetQuadSens1(void *cvode_mem, realtype *tret, int _is, N_Vector yQSout)
    
    int CVodeGetQuadSensDky(void *cvode_mem, realtype t, int k, N_Vector *dkyQS_all)
    int CVodeGetQuadSensDky1(void *cvode_mem, realtype t, int k, int _is, N_Vector dkyQS)
...
#    * -----------------------------------------------------------------
    ...
    int CVodeSStolerancesB(void *cvode_mem, int which,
...
#    * -----------------------------------------------------------------
    ...
    int CVodeGetB(void *cvode_mem, int which,
                                  realtype *tBret, N_Vector yB)
    int CVodeGetQuadB(void *cvode_mem, int which,
...
#     */
    ...
    ctypedef int (*CVDlsDenseJacFnB)(long int nB, realtype t,
    				N_Vector y, 
...
#     */
    ...
    ctypedef int (*CVDlsBandJacFnB)(long int nB, long int mupperB, long int mlowerB,
...
#     */
    ...
    int CVDlsSetDenseJacFnB(void *cvode_mem, int which,
                                            CVDlsDenseJacFnB jacB)
    int CVDlsSetBandJacFnB(void *cvode_mem, int which,
...
cdef extern from "cvodes/cvodes_band.h":
#    /*
#     * -----------------------------------------------------------------
#     * Function : CVBand
#     * -----------------------------------------------------------------
...
#     */
    ...
    ctypedef int (*CVSpilsPrecSetupFnB)(realtype t, N_Vector y,
    				   N_Vector yB, N_Vector fyB,
    				   booleantype jokB,
...
#     */
    ...
    ctypedef int (*CVSpilsPrecSolveFnB)(realtype t, N_Vector y,
    				   N_Vector yB, N_Vector fyB,
...
#     */
    ...
    ctypedef int (*CVSpilsJacTimesVecFnB)(N_Vector vB, N_Vector JvB, realtype t,
...
#     */
    ...
    int CVSpgmrB(void *cvode_mem, int which,
                                 int pretypeB, int maxlB)
                                 
cdef extern from "cvodes/cvodes_spbcgs.h":                           
#    /* 
#     * -----------------------------------------------------------------
#     * PART I - forward problems
#     * -----------------------------------------------------------------
...
#     */
    ...
    int CVSpbcgB(void *cvode_mem, int which,
                                 int pretypeB, int maxlB)
                                 
cdef extern from "cvodes/cvodes_sptfqmr.h":                  
#    /* 
#     * -----------------------------------------------------------------
#     * PART I - forward problems
#     * -----------------------------------------------------------------
...
#     */
    ...
    int CVSptfqmrB(void *cvode_mem, int which,
                                   int pretypeB, int maxlB)